...
class CreateKendaraansTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('kendaraans', function (Blueprint $table) {
            ...
            $table->string('isi_silinder')->length(50);
            $table->string('warna_kendaraan')->length(50);
            $table->string('bahan_bakar')->length(50);
            $table->string('warna_tnkb')->length(50);
            $table->date('tahun_registrasi');
            $table->string('no_mesin')->length(50);
            $table->string('no_bpkb')->length(50);
            $table->string('tercatat_kib')->length(50);
            $table->timestamps();
